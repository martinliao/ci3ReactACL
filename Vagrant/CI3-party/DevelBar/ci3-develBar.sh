...
cp /CI3Party/DevelBar/DevelBarProfiler.php ${DOCROOT}/application/controllers/

cp ${DOCROOT}/application/core/MY_Loader.php ~/
cp /CI3Party/DevelBar/develbar-core-MY_Loader.php ${DOCROOT}/application/core/MY_Loader.php
